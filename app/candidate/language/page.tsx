  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-green-900 to-green-700 flex flex-col items-center justify-center px-6">
      ...
      <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-xl">
        <h2 className="text-center text-gray-700 font-semibold text-lg mb-1">ಭಾಷೆ ಆಯ್ಕೆ ಮಾಡಿ</h2>
        <p className="text-center text-gray-400 text-sm mb-6">Select Language</p>
        <div className="space-y-3">
          <button onClick={() => choose("kn")}
            ...
            <div className="text-left">
              <p className="text-lg font-bold text-green-800">ಕನ್ನಡ</p>
              <p className="text-sm text-gray-400">Kannada</p>
            </div>
            <span className="ml-auto text-green-400 group-hover:text-green-600 text-xl">→</span>
          </button>
          <button onClick={() => choose("en")}
            ...
            <span className="text-3xl">🔤</span>
            <div className="text-left">
              <p className="text-lg font-bold text-blue-800">English</p>
              <p className="text-sm text-gray-400">ಇಂಗ್ಲಿಷ್</p>
            </div>
            <span className="ml-auto text-blue-400 group-hover:text-blue-600 text-xl">→</span>
          </button>
        </div>
      </div>
      <p className="mt-8 text-green-400 text-xs text-center">
        Directorate of Electronic Delivery of Citizen Services<br />Government of Karnataka
      </p>
    </main>
  );
}
