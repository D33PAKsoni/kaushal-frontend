...
export const T = {
  selectLanguage: { kn: "ಭಾಷೆ ಆಯ್ಕೆ ಮಾಡಿ", en: "Select Language" },
  languageSubtitle: { kn: "ನಿಮ್ಮ ಆದ್ಯತೆಯ ಭಾಷೆ ಆರಿಸಿ", en: "Choose your preferred language" },
  ...
  fillAllFields: { kn: "ದಯವಿಟ್ಟು ಎಲ್ಲಾ ಮಾಹಿತಿ ತುಂಬಿರಿ", en: "Please fill all fields" },
  connectionError: { kn: "ಸಂಪರ್ಕ ದೋಷ. ದಯವಿಟ್ಟು ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.", en: "Connection error. Please try again." },
  pleaseWait: { kn: "ದಯವಿಟ್ಟು ನಿರೀಕ್ಷಿಸಿ...", en: "Please wait..." },
  interviewStart: { kn: "ಸಂದರ್ಶನ ಪ್ರಾರಂಭಿಸಿ", en: "Start Interview" },
  readyQuestion: { kn: "ಸಂದರ್ಶನ ಪ್ರಾರಂಭಿಸಲು ಸಿದ್ಧರಿದ್ದೀರಾ?", en: "Ready to start the interview?" },
  enableCamera: { kn: "ಕ್ಯಾಮೆರಾ ಮತ್ತು ಮೈಕ್ ಆನ್ ಮಾಡಿ", en: "Enable camera and microphone" },
  quietPlace: { kn: "ಶಾಂತ ಸ್ಥಳದಲ್ಲಿ ಕುಳಿತುಕೊಳ್ಳಿ", en: "Sit in a quiet place" },
  eightQuestions: { kn: "8 ಪ್ರಶ್ನೆಗಳು · ~8 ನಿಮಿಷ", en: "8 questions · ~8 minutes" },
  ...
  scoringInProgress: { kn: "ಸ್ಕೋರಿಂಗ್ ನಡೆಯುತ್ತಿದೆ... ಫಲಿತಾಂಶ ಶೀಘ್ರದಲ್ಲಿ.", en: "Scoring in progress... Results coming soon." },
